  ...
  <div class="border-radius-xl mt-3 mx-3 position-relative" style="background-image: url('.../public/assets/img/vr-bg.jpg'">
 ...
 <!-- api meteo-->
              <div class="d-flex">
                <div class="me-auto">
                  <h1 class="display-1 font-weight-bold mt-n4 mb-0">Paris</h1>
                </div>
               
                <div class="me-auto">
                  <h1 class="display-1 font-weight-bold mt-n4 mb-0 mx-5">28°C</h1>
                  <h5 class="text-uppercase mb-0 ms-1 ms-5">Cloudy</h5>
                </div>
                <div class="ms-auto">
